    ...
    <div class="erp-card">
        ...
        <div class="erp-header">
            ...
            <div class="d-flex align-items-center gap-3 position-relative" style="z-index: 2;">
                ...
                <div>
                    <h4 class="erp-header-title">{{ __('pos.edit') }} {{ __('pos.manage', ['page' => __('pos.branches')]) }}</h4>
                    <p class="erp-header-subtitle">{{ app()->getLocale() == 'ar' ? 'تعديل بيانات الفرع الحالي وتنسيقه مع إعدادات النظام' : 'Modify current branch details, location, and parameters' }}</p>
                </div>
            </div>
        </div>
                ...
                <div class="row g-4">
                    ...
                    @if(app()->getLocale() == 'ar')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="erp-input-wrapper">
                                ...
                                <input type="text" id="name_en" name="name_en" class="erp-input" style="text-align: left !important;" dir="ltr" value="{{ old('name_en', $branch->getTranslation('name', 'en')) }}" placeholder="(Optional)">
                            </div>
                        </div>
                    @else
                        {{-- English First --}}
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="erp-input-wrapper bg-light">
                            ...
                            <input type="text" name="code" id="code" class="erp-input text-muted" value="{{ $branch->code }}" readonly style="cursor: not-allowed; text-align: {{ app()->getLocale() == 'ar' ? 'right' : 'left' }} !important;">
                        </div>
                    ...
                    @if(app()->getLocale() == 'ar')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="erp-input-wrapper">
                                ...
                                <input type="text" id="manager_ar" name="manager_ar" class="erp-input" style="text-align: {{ app()->getLocale() == 'ar' ? 'right' : 'left' }} !important;" dir="rtl" value="{{ old('manager_ar', $branch->getTranslation('manager', 'ar')) }}" placeholder="مثال: محمد أحمد">
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="erp-input-wrapper">
                                ...
                                <input type="text" id="manager_en" name="manager_en" class="erp-input" style="text-align: left !important;" dir="ltr" value="{{ old('manager_en', $branch->getTranslation('manager', 'en')) }}" placeholder="e.g. Mohamed Ahmed">
                            </div>
                        </div>
                    @else
                        {{-- English First --}}
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="erp-input-wrapper">
                            ...
                            <input type="tel" id="phone" name="phone" class="erp-input" value="{{ old('phone', $branch->phone) }}" placeholder="+966 5XXXXXXXX" style="text-align: {{ app()->getLocale() == 'ar' ? 'right' : 'left' }} !important;">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="erp-input-wrapper">
                            ...
                            <input type="email" id="email" name="email" class="erp-input" value="{{ old('email', $branch->email) }}" placeholder="branch@example.com" style="text-align: {{ app()->getLocale() == 'ar' ? 'right' : 'left' }} !important;">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4">
                    ...
                    @if(app()->getLocale() == 'ar')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="erp-input-wrapper">
                                ...
                                <input type="text" id="city_ar" name="city_ar" class="erp-input" style="text-align: {{ app()->getLocale() == 'ar' ? 'right' : 'left' }} !important;" dir="rtl" value="{{ old('city_ar', $branch->getTranslation('city', 'ar')) }}" placeholder="مثال: الرياض">
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="erp-input-wrapper">
                                ...
                                <input type="text" id="city_en" name="city_en" class="erp-input" style="text-align: left !important;" dir="ltr" value="{{ old('city_en', $branch->getTranslation('city', 'en')) }}" placeholder="e.g. Riyadh">
                            </div>
                        </div>
                    @else
                        {{-- English First --}}
                    ...
                    @if(app()->getLocale() == 'ar')
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea id="address_ar" name="address_ar" class="erp-textarea" style="text-align: {{ app()->getLocale() == 'ar' ? 'right' : 'left' }} !important;" dir="rtl" rows="3" placeholder="مثال: شارع العليا، حي المروج">{{ old('address_ar', $branch->getTranslation('address', 'ar')) }}</textarea>
                        </div>
                        <div class="col-md-6">
                            <label for="address_en" class="erp-label" style="text-align: {{ app()->getLocale() == 'ar' ? 'right' : 'left' }} !important;">{{ __('pos.address_en') }}</label>
                            <textarea id="address_en" name="address_en" class="erp-textarea" style="text-align: left !important;" dir="ltr" rows="3" placeholder="e.g. Olaya St, Muruj District">{{ old('address_en', $branch->getTranslation('address', 'en')) }}</textarea>
                        </div>
                    @else
                        {{-- English First --}}
                        <div class="col-md-6">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="erp-input-wrapper">
                            ...
                            <select name="branch_type" class="erp-input" style="cursor: pointer; text-align: {{ app()->getLocale() == 'ar' ? 'right' : 'left' }} !important;">
                                <option value="Branch" {{ old('branch_type', $branch->branch_type) == 'Branch' ? 'selected' : '' }}>{{ app()->getLocale() == 'ar' ? 'فرع عادي' : 'Branch' }}</option>
                                <option value="Main Branch" {{ old('branch_type', $branch->branch_type) == 'Main Branch' ? 'selected' : '' }}>{{ app()->getLocale() == 'ar' ? 'الفرع الرئيسي' : 'Main Branch' }}</option>
                                <option value="Warehouse" {{ old('branch_type', $branch->branch_type) == 'Warehouse' ? 'selected' : '' }}>{{ app()->getLocale() == 'ar' ? 'مستودع / مخزن' : 'Warehouse' }}</option>
                                <option value="Outlet" {{ old('branch_type', $branch->branch_type) == 'Outlet' ? 'selected' : '' }}>{{ app()->getLocale() == 'ar' ? 'منفذ بيع' : 'Outlet' }}</option>
                                <option value="Kiosk" {{ old('branch_type', $branch->branch_type) == 'Kiosk' ? 'selected' : '' }}>{{ app()->getLocale() == 'ar' ? 'كشك' : 'Kiosk' }}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="erp-input-wrapper">
                            ...
                            <input type="date" name="opening_date" class="erp-input" value="{{ old('opening_date', $branch->opening_date) }}" style="cursor: pointer; text-align: {{ app()->getLocale() == 'ar' ? 'right' : 'left' }} !important;">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex align-items-center justify-content-between p-3 bg-light rounded-3" style="border: 1px dashed #cbd5e1; border-radius: 10px;">
                            ...
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" {{ old('is_active', $branch->is_active) ? 'checked' : '' }} style="cursor: pointer; width: 45px; height: 22px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="notes" class="erp-textarea" rows="3" placeholder="{{ app()->getLocale() == 'ar' ? 'ملاحظات سرية تخص الفرع...' : 'Internal notes about the branch...' }}" style="text-align: {{ app()->getLocale() == 'ar' ? 'right' : 'left' }} !important;">{{ old('notes', $branch->notes) }}</textarea>
                    </div>
                </div>
            </div>
