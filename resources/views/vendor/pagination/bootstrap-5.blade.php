@if ($paginator->total() > 0)
    <nav class="d-flex justify-items-center justify-content-between pagination-container">
        ...
        <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
            <div class="pagination-info">
                <p class="small text-muted mb-0" style="font-size: 0.9rem !important; color: #64748B !important; margin: 0;">
                    {!! __('Showing') !!}
